...
/**
 * GeoPoint is an ordered pair of x and y in the real number plain.
 * There is a method to calculate the distance between two points. 
 * There is another method that converts the GeoPoint to Point2D.
 * There is a method that converts the orderpair to integers. 
 * @author neil
 *
 */
public class GeoPoint {
	...
	public float distance(GeoPoint other) {
		float xdis = (float)(other.xco-this.xco);
		float xSquare = (float)(xdis*xdis);
		float ydis = (float)(other.yco-this.yco);
		float ySquare = (float)(ydis*ydis);
		float disSquare = (float)(ySquare + xSquare);
