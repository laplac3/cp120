...
public class NestedClassSample1 implements Runnable
{
    ...
    {
        NestedClassSample1  sample  = new NestedClassSample1();
    ...
    private class ButtonMgr implements ActionListener
    {
        public void actionPerformed( ActionEvent evt )
        {
            ...
            if ( src == colorButton )
                ...
                System.exit(1); // in case there is unintended functionality 
            }
        }
